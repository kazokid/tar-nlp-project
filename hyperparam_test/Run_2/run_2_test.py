...
from models.baseline.baseline import Baseline3Layer, Baseline4Layer
...
models_dict = {
    ...
    "early_fuse3layer": (Baseline3LayerWST2, train_st2, evaluate_st2),
    "early_fuse4layer": (Baseline4LayerWST2, train_st2, evaluate_st2),
    "late_fuse3layer": (
        Baseline3LayerWST2LateFuse,
        train_later_fuse,
        evaluate_later_fuse,
...
saved_models = {
    "baseline3layer": {
        "path": "baseline3layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
    "baseline4layer": {
        "path": "baseline4layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
    "early_fuse3layer": {
        "path": "early_fuse3layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
    "early_fuse4layer": {
        "path": "early_fuse4layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
    "late_fuse3layer": {
        "path": "late_fuse3layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
    "late_fuse4layer": {
        "path": "late_fuse4layer.pth",
        "best_validation_micro": 0.0,
        "seed": 0,
    },
}
...
if __name__ == "__main__":
    all_results = []
    seen_configs = set()
    RESULTS_CSV_FILENAME = "{model}_test_results_2.csv"

    seeds = [42, 65, 100, 456, 789]
    for seed in seeds:
        for model_name in models_dict.keys():
            ...
            if (
                ...
                print(
                    f"Skipping {model_name} with seed {seed} as it has already been run"
                )
                continue
