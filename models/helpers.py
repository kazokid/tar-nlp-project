...
CLASSES_SUBTASK_3_PATH = os.path.join(BASE_PATH, "bundle/scorers/techniques_subtask3.txt")
...
def get_paths(language):
    ...
    paths = {
        ...
        'train_labels': os.path.join(BASE_PATH, f"bundle/data/{language}/train-labels-subtask-3.txt"),
        'dev_labels': os.path.join(BASE_PATH, f"bundle/data/{language}/dev-labels-subtask-3.txt"),
    }
    return paths