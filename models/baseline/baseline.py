...
class Baseline2Layer(nn.Module):
    def __init__(
        self, embeddings_dimension: int, num_classes: int, drop: float = 0.2
    ) -> None:
        super().__init__()
...
class Baseline4Layer(nn.Module):
    def __init__(
        self, embeddings_dimension: int, num_classes: int, drop: float = 0.2
    ) -> None:
        super().__init__()
...
class Baseline5Layer(nn.Module):
    def __init__(
        self, embeddings_dimension: int, num_classes: int, drop: float = 0.2
    ) -> None:
        super().__init__()
...
def main():
    ...
    model = Baseline2Layer(768, len(train_datataset.labels_transformer.classes))
